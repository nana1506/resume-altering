                ...
                {user ? (
                  <>
                    ...
                    <div className="flex items-center gap-2 pl-1">
                      <Link 
                        href="/profile"
                        className="w-8 h-8 rounded-full bg-slate-100 hover:bg-indigo-50 hover:text-indigo-600 border border-slate-200 flex items-center justify-center text-slate-600 text-xs font-semibold transition-colors" 
                        title={`Profile Settings: ${user.email}${isAdmin ? ' (Admin)' : ''}`}
                      >
